...
const URL_SETTINGS = `${MAIN_URL}settings`; // 설정 페이지
const URL_STANDARD_TIME = `${MAIN_URL}standardTime`; // 근무시간 설정 페이지
...
const API_URL_UPDATE_PROFILE = `${API_URL}/updateProfile`;
